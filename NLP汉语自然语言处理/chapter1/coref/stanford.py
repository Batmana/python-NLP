...
class StanfordCoreNLP(object):
	def __init__(self,jarpath):
		...
		self.jarlist = ["stanford-corenlp-3.6.0.jar","stanford-chinese-corenlp-2015-12-08-models.jar","ejml-0.23.jar","javax.json.jar","jollyday.jar","joda-time.jar","protobuf.jar","slf4j-api.jar","slf4j-simple.jar","xom.jar"]
		self.jarpath = ""
		self.buildjars()
